...
<?php if($_GET['type']==2){ ?>
    ...
    <strong>｡:.ﾟヽ(*´∀`)ﾉﾟ.:｡　成功編輯好  <?php echo $_GET['id']." - ".urldecode($_GET['title']); ?>  了！ლ(╹◡╹ლ)</strong><br /><br />

    <strong style="font-size:2em"><?=$emojis[array_rand($emojis)];?> <?=$txts[array_rand($txts)];?> <?=$emojis[array_rand($emojis)];?></strong><br /><br />
