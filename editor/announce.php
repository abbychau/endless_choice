	...
	<body>
		...
		<form method="post" action="<?=$editFormAction; ?>">
			<fieldset style="padding-left:10px"><legend>修改Endless Choice 首頁簡介</legend>
				<textarea name="conclusion" cols="80" rows="12" id="conclusion"><?=$world_info['conclusion']; ?></textarea> 
			</fieldset>
			<fieldset style="padding-left:10px"><legend>修改進入頁面</legend>
				<textarea name="entertext" cols="80" rows="20" id="entertext"><?=$world_info['entertext']; ?></textarea>
			</fieldset>
			<fieldset style="padding-left:10px">
				<legend>修改</legend>
				作者名:<input name="author" type="text" id="author" value="<?=$world_info['author']; ?>" size="40" disabled="disabled" /><br />
				劇本名:<input name="name" type="text" id="name" value="<?=$world_info['name']; ?>" size="40" />
			</fieldset>
			<fieldset style="padding-left:10px">
				<legend>修改討論貼編號</legend>
				tid: <input name="tid" type="text" size="40" value="<?=$world_info['tid']; ?>" />
			</fieldset>
